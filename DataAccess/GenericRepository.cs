...
{
    // this is the implement of the genericRepository to the data layer >> need to declare here so that the function will work
    public class GenericRepository<T> : IGenericRepository<T> where T : class
    {
        ...
        //inherate and overide the interface/ signatures
        public virtual T Get(Expression<Func<T, bool>> predicate, bool trackChanges = false, string? includes = null)
        {
            ...
            //predicate = WHERE in SQL, as it is a get query >>
