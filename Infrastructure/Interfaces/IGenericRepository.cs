...
{
    public interface IGenericRepository<T> where T : class // The interface will have a generic class as parameter
    {
        ...
        // The Expression can considere as Where in SQL, Expression is C# keyword
        // trackChanges: do I want to update changes everytime the function is call
        ...
        //Async Call: the web page does its things while the database does its thing
        //Sync Call: the workflow is one at a time
